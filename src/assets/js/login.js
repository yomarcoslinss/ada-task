...
const cadastrar = () => {
  const valueUsuario = capturarValor(inputCadastroUsuario);
  const valueEmail = capturarValor(inputCadastroEmail);
  const valueSenha = capturarValor(inputCadastroSenha);
